...
- Public `/submit`: use the structured GitHub price observation and correction issue forms.
...
## Optional Public Form Setup

A public form is optional. GitHub issue forms remain the no-cost fallback.

If a Tally, Google Form, or similar form is created manually, configure only the public respondent URL:
